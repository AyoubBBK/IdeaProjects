...
public class ConsumerContainer extends Application {
    ...
    private ConsumerAgent consumerAgent;//reference de l'agent dans le conteneur
    ...
    public void startcontainer(){
        ...
        try {
            agentController=container.createNewAgent("Consumer","agents.ConsumerAgent",new Object[]{this});//envoi de l'interface graphique
